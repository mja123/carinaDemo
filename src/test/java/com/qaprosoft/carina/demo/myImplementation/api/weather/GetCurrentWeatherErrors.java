...
@ResponseTemplatePath(path = "api/weather/_getError/rsError.json")
@SuccessfulHttpStatus(status = HttpResponseStatusType.UNAUTHORIZED_401)
public class GetCurrentWeatherErrors extends AbstractApiMethodV2 {

    public GetCurrentWeatherErrors() {
